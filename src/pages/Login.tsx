    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background px-6">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-[13px] text-muted-foreground mt-1.5">Continue to your cognitive layer</p>
        </div>
        ...
        <div className="flex flex-col gap-3 mb-6">
          <motion.button
            whileTap={{ scale: 0.98 }}
            className="w-full flex items-center justify-center gap-3 h-12 rounded-full bg-card border border-border text-foreground text-[14px] font-medium shadow-sm hover:shadow-md hover:bg-surface-hover transition-all duration-200"
          >
        ...
        <div className="flex flex-col gap-3 mb-5">
          <input
            ...
            className="w-full bg-card rounded-2xl px-4 h-12 text-[14px] text-foreground placeholder:text-muted-foreground outline-none border border-border focus:border-primary focus:ring-1 focus:ring-primary/20 transition-all duration-200"
          />
          <input
            type="password"
            value={password}
        ...
        <div className="flex justify-between mt-5 px-1">
          <button className="text-[13px] text-primary font-medium hover:underline transition-all">Forgot password?</button>
          <button onClick={() => navigate("/signup")} className="text-[13px] text-primary font-medium hover:underline transition-all">
            Create account
          </button>
        </div>
