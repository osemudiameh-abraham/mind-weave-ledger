      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          <svg width="40" height="40" viewBox="0 0 28 28" fill="none" className="mb-3">
            <path d="M14 0C14 7.732 7.732 14 0 14c7.732 0 14 6.268 14 14 0-7.732 6.268-14 14-14-7.732 0-14-6.268-14-14z" fill="url(#loginsparkle)"/>
            <defs>
              <linearGradient id="loginsparkle" x1="0" y1="0" x2="28" y2="28">
