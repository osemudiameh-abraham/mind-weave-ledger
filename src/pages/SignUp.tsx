      ...
      >
        <div className="flex flex-col items-center mb-8">
          <svg width="40" height="40" viewBox="0 0 28 28" fill="none" className="mb-3">
            <path d="M14 0C14 7.732 7.732 14 0 14c7.732 0 14 6.268 14 14 0-7.732 6.268-14 14-14-7.732 0-14-6.268-14-14z" fill="url(#signupsparkle)"/>
            <defs>
              <linearGradient id="signupsparkle" x1="0" y1="0" x2="28" y2="28">
        ...
        <div className="flex gap-3 mb-6">
          <motion.button whileTap={{ scale: 0.97 }} className="flex-1 flex items-center justify-center gap-2 py-3 rounded-full bg-card border border-border text-foreground text-sm font-medium shadow-sm">
        ...
        <div className="flex flex-col gap-3 mb-4">
          ...
          <div className="relative">
            <input type={showPw ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Password"
              className="w-full bg-card rounded-xl px-4 pr-10 py-3 text-sm text-foreground placeholder:text-muted-foreground outline-none border border-border focus:border-primary transition-colors" />
