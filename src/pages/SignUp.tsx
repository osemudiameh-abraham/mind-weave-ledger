...
const SignUp = () => {
  ...
  const handleSocialAuth = async (method: "google" | "apple") => {
    if (method === "google") {
      ...
      toast("Apple sign-up coming soon", { duration: 3000 });
    }
  };
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background px-6">
      ...
      >
        ...
        <div className="flex gap-3 mb-6">
          <motion.button whileTap={{ scale: 0.98 }} onClick={() => handleSocialAuth("google")} disabled={!!socialLoading} className="flex-1 flex items-center justify-center gap-2 h-12 rounded-full bg-card border border-border text-foreground text-[14px] font-medium shadow-sm hover:shadow-md hover:bg-surface-hover transition-all duration-200 disabled:opacity-60">
