...
const traces = [
  {
    ...
    reasoning:
      "Based on your energy tracking data (23 entries), design reviews consistently scored lowest. Combined with your stated goal of freeing up 4+ hours/week.",
  ...
  },
  {
    ...
    reasoning:
      "You've revisited the 'hire vs contract' question 4 times in 3 weeks without resolution. This matches a pattern of avoidance when stakes feel high.",
  ...
  },
  {
    ...
    reasoning:
      "You set this as a tracked commitment on Mar 15. Compliance has dropped to 40% over the last 5 days.",
  ...
  },
  {
    ...
    reasoning:
      "Your messages about Series B started showing stress markers on Mar 20. Your reported sleep quality dropped from 8/10 to 5/10 in the same period.",
                    ...
                    <div className="pt-3">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {trace.sources.map((s, j) => (
                          <span
                            key={j}
                            className="text-[11px] bg-muted text-muted-foreground px-3 py-1 rounded-full"
                          >
                            {s}
                          </span>
                        ))}
